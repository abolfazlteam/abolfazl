...
export const PROJECTS: Project[] = [
  {
    ...
    gallery: [
      { id: "ticket-chat", label: "Ticket conversation and message composer", aspect: "16 / 10" },
  ...
  },
  {
    ...
    gallery: [
      { id: "iran-map-sdk", label: "React map SDK component states", aspect: "16 / 10" },
      { id: "iran-map-assets", label: "Vector tile, glyph, sprite, and style asset server" },
  ...
  },
  {
    ...
    stack: ["Next.js", "TypeScript", "TanStack Query", "React Hook Form", "Storybook", "Docker"],
    accent: "violet",
    metric: "491 commits",
    likes: 152,
    ...
    gallery: [
      { id: "svc-dashboard", label: "Service workflow dashboard and module table", aspect: "16 / 10" },
  ...
  },
  {
    ...
    stack: ["Next.js", "TypeScript", "TanStack Query", "React Hook Form", "MinIO", "Storybook"],
    accent: "amber",
    metric: "246 commits",
    likes: 131,
    ...
    gallery: [
      { id: "myco-payments", label: "Annual fee payment method branching", aspect: "16 / 10" },
  ...
  },
  {
    ...
    stack: ["Next.js", "TypeScript", "Tailwind", "OTP UX", "Docker", "GitLab CI"],
    accent: "rose",
    metric: "solo build",
    likes: 118,
    role: "Frontend owner",
    ...
    gallery: [
      { id: "sso-login", label: "Password and OTP login states", aspect: "16 / 10" },
      { id: "sso-otp", label: "OTP input, resend, and validation states" },
      { id: "sso-callback", label: "Consent, callback, and error recovery screens" },
    ],
  },
  {
    id: "sadaf-front",
    ...
    stack: ["Next.js", "TypeScript", "TanStack Query", "React Hook Form", "Leaflet", "SEO"],
    accent: "violet",
    metric: "169 commits",
    likes: 127,
    role: "Major frontend contributor",
    ...
    gallery: [
      { id: "sadaf-search", label: "Public job search, filters, and pagination", aspect: "16 / 10" },
  ...
  },
  {
    ...
    stack: ["Next.js", "TypeScript", "TanStack Query", "Zustand", "React Hook Form", "Jalali Dates"],
    accent: "sky",
    metric: "57 commits",
    likes: 104,
    ...
    gallery: [
      { id: "rahsa-calendar", label: "Meeting-room calendar grid", aspect: "16 / 10" },
      { id: "rahsa-meeting-modal", label: "Meeting create/edit modal and conflicts" },
