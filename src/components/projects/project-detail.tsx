...
import { ProjectListItemWithPreview } from "@/components/projects/project-list-item";
  ...
  return (
    <Container className="pt-[clamp(28px,4vw,48px)]">
      ...
      <div
        ...
        style={{
          background: `linear-gradient(140deg, ${accent}, ${accentSoft(project.accent, 67)})`,
        }}
      >
        <div
          ...
          <div className="mt-10">
            ...
            <ul className="m-0 flex list-none flex-col gap-3.5 p-0">
              {project.highlights.map((highlight, i) => (
                <li
                  key={i}
                  className="flex gap-3.5 font-sans text-base leading-[1.6] text-text"
                >
                  <span
        ...
        <div className="flex flex-col gap-4 rounded-[14px] border border-border bg-surface p-[22px]">
          {(
            ...
            <div key={label}>
              ...
              <div className="mt-1 font-sans text-[15px] text-text">
                {value}
              </div>
            </div>
          ))}
          <div>
            <div className="mb-2 font-mono text-[10px] uppercase tracking-[1.5px] text-faint">
              Stack
            </div>
      ...
      <div className="mt-[clamp(40px,5vw,64px)]">
        ...
        <div className="mt-5 border-t border-line">
          <ProjectListItemWithPreview project={next} index={nextIndex} />
        </div>
      </div>
    </Container>
  );
